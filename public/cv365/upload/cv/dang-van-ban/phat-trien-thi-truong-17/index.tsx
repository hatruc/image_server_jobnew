			...
			<div id="page-cv">
				...
				<div id="form-cv">
					<div className="cv_page height_page" data-page={1}>
						...
						<div className="all" style={{ paddingTop: '21.35px' }}>
							<div id="cv-main" style={{}}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box01" className="block cvo-block box-contact ui-sortable-handle" style={{ marginTop: '4.88125px' }}>
												{' '}
											...
											<div id="box02" className="block cvo-block ui-sortable-handle" style={{ marginTop: '4.88125px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div
															...
															style={{ marginTop: '4.88125px' }}
														>
															Mong có thể học hỏi thêm nhiều kinh nghiệm, trau dồi nhiều kỹ năng trong ngành thị trường và có mức thu nhập ổn định{' '}
															<br />
															Phấn đấu trở thành một nhân viên phát triển thị trường chuyên nghiệp, được làm việc ở trong môi trường có nhiều thử
															thách và năng động để phát triển bản thân hơn nữa. Hy vọng công ty luôn tạo điều kiện giúp nhân viên thăng tiến trong
															công việc.&nbsp;
															<br />{' '}
														</div>
													</div>
											...
											<div id="box03" className="block cvo-block box-skills ui-sortable-handle" style={{ marginTop: '4.88125px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
											...
											<div id="box05" className="block cvo-block ui-sortable-handle" style={{ marginTop: '4.88125px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '32.025px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '16.0125px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
											...
											<div id="exp2" className="ctbx experience" style={{ marginTop: '16.0125px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
					...
					<div className="cv_page page_more height_page" data-page={2}>
						<div className="all" style={{ paddingTop: 0 }}>
							<div id="cv-main" style={{ paddingBottom: '500.4px' }}>
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true" style={{ marginTop: 0 }}>
															- Cá nhân có thành tích xuất sắc trong hoạt động tình nguyện của Đội sinh viên tình nguyện trường Đại học Thương mại{' '}
															<br />- Nhân viên tích cực tại Công ty Thiết bị động cơ Xe máy CV365
															<br />{' '}
														</div>
													</div>
												</div>
