				...
				<div id="form-cv">
						...
						<div className="all" style={{ paddingTop: '4.1px' }}>
								...
								<div id="cv-right">
									<div className="ir">
										<div id="sortable" className="connectedSortable sortable ui-sortable">
											<div id="box01" className="block cvo-block box-contact ui-sortable-handle" style={{ marginTop: '1.38333px' }}>
												{' '}
											...
											<div id="box02" className="block cvo-block ui-sortable-handle" style={{ marginTop: '1.38333px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
												...
												<div className="ct_bo">
													<div className="ct_box">
														<div
															...
															style={{ marginTop: '1.38333px' }}
														/>
													</div>
												</div>
											</div>
											<div id="box03" className="block cvo-block box-skills ui-sortable-handle" style={{ marginTop: '1.38333px' }}>
												{' '}
												<div className="blockControls">
													<div title="Di chuyển khối" className="show-layout-editor">
														<i className="fa fa-bars" />
												...
												<div className="ski">
													...
													<div id="boxtitle">
														...
														<div
															...
															className="box-title"
															dangerouslySetInnerHTML={{ __html: `${html?.menu[2]?.content?.title}` }}
														/>
													</div>
												</div>
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '3.075px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
									...
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '3.075px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											{html?.experiences[1]?.content?.content?.map((item: any, index: number) => {
												return (
													<div key={index} id="exp1" className="ctbx experience" style={{ marginTop: '2.05px' }}>
														{' '}
														<div className="fieldgroup_controls">
															<div className="clone">
																<i className="fa fa-plus" /> Thêm
					...
					<div className="cv_page page_more height_page" data-page={2}>
						<div className="all" style={{ paddingTop: 0 }}>
							...
							<div id="cv-content" style={{ paddingBottom: '552.4px' }}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
