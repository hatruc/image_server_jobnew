										...
										<div className="ir">
											<div id="sortable" className="ui-sortable">
												...
												<div id="box02" className="block cvo-block ui-sortable-handle">
													...
													<p>
														<span className="box-content err_cv_content" cvo-placeholder="Content" contentEditable="true">
															...
															<br />
															With 3 years of experience in equivalent positions in Administrative Personnel major and my passion, constantly learning
															for work, I believe that I will be successful when I am accepted.
															<br />
												...
												<div id="box04" className="block cvo-block ui-sortable-handle">
													...
													<p>
														<span className="box-content err_cv_content" cvo-placeholder="Content" contentEditable="true">
															- Certificate of merit of the delegation for outstanding achievements in the process of joining the team at the
															university.
												...
												<div id="experience-table">
													<div id="exp1" className="ctbx experience">
														...
														<div
															...
															cvo-placeholder="Job description and task achievements."
														>
															Administrative office:
															<br />- Complying with the regulations of the company and laws of the State such as: day-off leave, retirement leave,
															absent from work, payroll, social insurance, tax registration for employees and benefits related to salary, appointment,
															assignment ... for the staff in the company
															<br />- Managing the company's seal, documents, directly managing of stationery, managing of machinery and equipment in
															the office; implementing the administrative documents of the company. Archiving media contracts, advertising in a
															scientific way. Signing and sealing of official letters, acceptance minutes of communication contracts, advertisements,
															events, ...
															<br />
												...
												<div id="experience-table">
													<div id="exp1" className="ctbx experience">
														...
														<div
															...
															cvo-placeholder="Job description and task achievements."
														>
															+/ Supporting competition season 2015, 2016: Supporting Candidates and their relatives on campus when taking the
