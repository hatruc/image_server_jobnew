							...
							<div id="cv-right">
								<div className="ir">
									...
									<div id="sortable" className="ui-sortable">
										<div id="box01" className="block cvo-block box-contact bg2 ui-sortable-handle">
											{' '}
											...
											<p className="icoweb cvi-phone">
												{' '}
												<span id="cv-profile-phone" cvo-placeholder="Telephone number" contentEditable="true" /> <i className="fa"></i>
											</p>
											...
											<p className="icoweb cvi-map-marker">
												{' '}
												<span id="cv-profile-address" cvo-placeholder="Address" contentEditable="true" /> <i className="fa"></i>
											</p>
										</div>
										...
										<div id="box03" className="block cvo-block box-skills bg2 ui-sortable-handle">
											{' '}
											<div className="blockControls">
												<div title="Di chuyển khối" className="show-layout-editor">
													<i className="fa fa-bars" />
										...
										<div id="box05" className="block cvo-block bg2 ui-sortable-handle">
											{' '}
											<div className="blockControls">
												<div title="Di chuyển khối" className="show-layout-editor">
													<i className="fa fa-bars" />
										...
										<div id="box07" className="block cvo-block bg2 ui-sortable-handle">
											{' '}
											<div className="blockControls">
												<div title="Di chuyển khối" className="show-layout-editor">
													<i className="fa fa-bars" />
