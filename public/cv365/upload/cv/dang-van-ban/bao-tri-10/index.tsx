							...
							<div className="ir">
								<div id="sortable" className="ui-sortable">
									<div id="box01" className="block cvo-block box-contact ui-sortable-handle">
										...
										{/*  <p class="icoweb cvi-info"><span id="cv-profile-face" cvo-placeholder="홈페이지 (Facebook)" contenteditable="true"></span></p> */}
									</div>
									<div id="box02" className="block cvo-block ui-sortable-handle">
										...
										<span className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
											상사 및 동료로부터 전기 및 전자에 대한 공사에서 유지 보수 감독, 관리에 대해 배우고 경험을 축적하고 계획을 수립합니다.&nbsp;3년
											후 유지 보수 부서의 기사장이 되기 위해 노력하며 자신의 승진 기회를 향상하고 노동 안전 시스템 유지 보수 계획을 작성하고 기업의
											장기 개발과 동행합니다.&nbsp;{' '}
										</span>
									</div>
									...
									<div id="box04" className="block cvo-block ui-sortable-handle">
										...
										<span className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
											2012년 국가 인터넷 수학 대회 3등상FTU대의 최우수한 학생{' '}
										</span>
									</div>
									<div id="box05" className="block cvo-block ui-sortable-handle">
										...
										<span className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
											B급 사무실용 컴퓨터 공학TOEIC 750 영어 자격증{' '}
										</span>
									</div>
									<div id="box06" className="block cvo-block ui-sortable-handle">
										...
										<span className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
											여행&nbsp;기술 개발 클럽 가입중고 가전 제품, 장비 관련 기술 장비 제작{' '}
										</span>
									</div>
									<div id="box07" className="block cvo-block ui-sortable-handle">
										...
										<span className="box-content err_cv_content" cvo-placeholder="내용" contentEditable="true">
											Ms. Hoang Ngoc Anh&nbsp;CV365 무역 및 식당 주식회사-인사팀장인사팀장전화번호: 0985 237 168{' '}
										</span>
									</div>{' '}
								</div>
							</div>
							...
							<div id="block02" className="cvo-block ui-sortable-handle">
								...
								<div id="experience-table">
									<div id="exp1" className="ctbx experience">
										...
										<h3>
											<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="회사명">
												기간: 2017/7월~2018/8월NHK 투자 건설 주식회사
											</div>
										</h3>
										<p className="h3">
											<span className="exp-subtitle" cvo-placeholder="작업 위치" contentEditable="true">
										...
										>
											전기, 수도, 에어컨을 포함한 기술 장비 시스템 설치 및 운영, 사무실에서 효과적인 운영 보장건설 기계수리 정기적으로 건설 현장에서
											기계 작동 조사감시 카메라 활동 모니터링{' '}
										</div>
									</div>
									<div id="exp2" className="ctbx experience">
										...
										<h3>
											<div className="exp-title err_cv_content" contentEditable="true" cvo-placeholder="회사명">
												기간: 2018/9~현재CV365 무역 및 식당 주식회사
											</div>
										</h3>
										<p className="h3">
											<span className="exp-subtitle" cvo-placeholder="작업 위치" contentEditable="true">
										...
										<div
											...
											cvo-placeholder=" 업무에서 달성되는 업무 세부 사항을 설명한다."
										>
											전기 및 수도 시스템의 작동 상태 확인 및 장비 고장 원인 분석CMMS 시스템의 보고서, KPI 지표를 분석하고 장비 및 유지 보수 시스템의
											효과를 평가함&nbsp;교육 장비의 수리 프로세스 분석{' '}
										</div>
									</div>
								</div>
							</div>
							<div id="block03" className="cvo-block ui-sortable-handle">
								...
								<div id="experience-table">
									<div id="exp1" className="ctbx experience">
										...
										<p className="h3">
											<span className="exp-subtitle" cvo-placeholder="작업 위치" contentEditable="true">
												중부의 홍수 지역 주민들을위한 옷과 음식 기부, 지원 및 청년단이 조직한Thanh Hoa시에서 생나무 심기 프로젝트&nbsp;
											</span>
										</p>
										<div
											className="exp-content err_cv_content"
											...
											cvo-placeholder=" 업무에서 달성되는 업무 세부 사항을 설명한다."
										>
											“Thanh Hoa 빨간 행정-피 한 방울이 주게 될 때 한 생명을 구할 수 있다” 헌혈 프로그램에 가입&nbsp;학교의 “엔지니어를위한 젊은
											차의력 클럽 회원{' '}
										</div>
									</div>
								</div>
								...
								<div id="experience-table">
									<div id="exp1" className="ctbx experience">
										...
										<div
											...
											cvo-placeholder=" 업무에서 달성되는 업무 세부 사항을 설명한다."
										>
											결과 :&nbsp; 자격을 갖춘 숙련 된 직원을 회사의 직원 배치 장비에 참여시키기 위해 직원을 배치하고 숙련 된 직원을지도하고 고도의
											전문 기술을 훈련 할 수 있도록 필터링합니다.
											<br />{' '}
										</div>
									</div>
								</div>
