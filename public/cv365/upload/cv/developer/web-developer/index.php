...
<link id="cv-color-css" rel="stylesheet" href="upload/cv/<?php echo $item->alias; ?>/css/colors/<?php echo $color_active; ?>.css?v=2" type="text/css">
...
<div id="page-cv">    
	            ...
	            <div id="cvo-profile">                
	                <div class="box-01">   
	                    <div id="box-hvt">
	                        ...
	                        <p><h2><span id="cv-profile-job" contenteditable="true" cvo-placeholder="<?php echo $holder_job; ?>"><?php echo $position; ?></span></h2></p>
                    ...
                    <div id="sortable">
						...
						<?php if($m['type']=="profile"){ ?>	                        
                            ...
                            <div id="prof">
                                ...
                                <div class="ic">
                                    <p class="icf"><i class="fa">&#xf129;</i></p>
                                    <p class="icoweb"><span id="cv-profile-face" cvo-placeholder="<?php echo $holder_face; ?>" contenteditable="true"><?php echo $m['content']->face; ?></span></p>
                                </div>
                                <div class="clr"></div>
                            </div>
                            <div class="clr"></div>
						<?php }else if($m['type']=="skill"){ ?>
                            <?php echo $controls; ?>
                        <h3><div id="cv-boxtitle" cv-form-field="true" contenteditable="true" cvo-placeholder="<?php echo $holder_box_title; ?>" class="box-title"><?php echo $m['title']; ?></div></h3>
    ...
    </div><div class="watermark">© Timviec365.vn</div>
</div>