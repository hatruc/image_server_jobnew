            ...
            <div id="cvo-profile">
                <div class="box-01">
                    ...
                    <div class="ifo">
                        <div class="chu">
                            <h1>
                                <div id="cv-profile-fullname" cvo-placeholder="<?php echo $holder_name; ?>" contenteditable="true"><?php echo $fullname; ?></div>
                            </h1>
                            <div class="clr"></div>
                            <h2><div class="fake-j"></div><span id="cv-profile-job" contenteditable="true" cvo-placeholder="<?php echo $holder_job; ?>"><?php echo $position; ?></span></h2>
                            <div class="clr"></div>
                        </div>
                    </div>
                    <div id="box-hvt">
                                ...
                                ?>
                                    ...
                                    <?php if ($bl->title != '') { ?>
                                        <h3>
                                            ...
                                            <?php if ($bl->date != '') { ?>
                                                <div class="bg-date"><div class="exp-date" contenteditable="true" cvo-placeholder="<?php echo $holder_block_time; ?>"><?php echo $bl->date; ?></div></div>
                                            <?php } ?>
                                        </h3>
                                    <?php } ?>
                                    <?php if ($bl->subtitle != '') { ?>
