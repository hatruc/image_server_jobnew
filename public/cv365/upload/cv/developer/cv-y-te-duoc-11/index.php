						...
						if($m['type']=="profile"){ 
							...
							<div id="prof">
								...
								<div class="ic-phone">
									...
									<p class="icf"><i class="fa">&#xf095;</i></p>
									<p class="icoweb"><span id="cv-profile-phone" cvo-placeholder="<?php echo $holder_phone; ?>" contenteditable="true"><?php if(isset($phone)){echo $phone;}else{echo $m['content']->phone;} ?></span></p>
								...
								<div class="ic-address">
									<p class="icf"><i class="fa">&#xf041;</i></p>
									<p class="icoweb"><span id="cv-profile-address" cvo-placeholder="<?php echo $holder_address; ?>" contenteditable="true"><?php if(isset($address)){echo $address;}else{echo $m['content']->address; }?></span></p>
								</div>
								<div class="clr"></div>
							</div>
				...
				<div id="cv-main">
					<div id="cv-right">
						...
						<div id="cv-content">
							...
							<div class="watermark">&there4; Timviec365.vn</div>
						</div>
					</div>
