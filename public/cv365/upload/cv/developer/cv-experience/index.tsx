							...
							<div className="ir">
								<div id="sortable" className="ui-sortable">
									<div id="box01" className="block cvo-block box-contact ui-sortable-handle">
										<div id="prof">
											<div className="ic ic_phone">
												<p className="icoweb">
													<i className="fa"></i>
													<span id="cv-profile-phone" cvo-placeholder="Điện thoại" contentEditable="true" />
												</p>
											</div>
											<div className="ic ic_date">
									...
									<div id="box02" className="block cvo-block ui-sortable-handle">
										...
										<span className="box-content err_cv_content" cvo-placeholder="Nội dung" contentEditable="true">
											- Mong muốn tìm một môi trường làm việc phù hợp với chuyên môn, năng lực với một chế độ đãi ngộ tốt để Tôi có thể cống hiến hết
											mình cho công việc.
											<br />- Tìm hiểu, nghiên cứu sâu hơn về ngành kỹ thuật điện những công nghệ mới cũng như áp dụng những kiến thức kinh nghiệm đã
											có vào công việc, thực hiện mục tiêu trở thành một chuyên gia trong lĩnh vực kỹ thuật điện tử.
											<br />{' '}
										</span>
									</div>
