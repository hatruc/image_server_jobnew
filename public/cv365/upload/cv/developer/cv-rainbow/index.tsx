										...
										<div id="experience-table">
											...
											<div id="exp2" className="ctbx experience">
												...
												<div
													...
													cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
												>
													- Tìm hiểu môi trường làm việc của các nhân viên kỹ sư cơ điện tử, thiết bị điện – điện tử trong công ty.- Làm báo cáo thực
													tập{' '}
												</div>
											</div>{' '}
										</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience">
												...
												<div
													...
													cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
												>
													Công việc: lên ý tưởng cho hệ thống cảnh báo, thiết kế phần cứng và lập trình, chạy thử nghiệm và nâng cấp hệ thống cảnh
													báo. Báo cáo đồ án tốt nghiệp{' '}
												</div>
											</div>{' '}
										</div>
									</div>
