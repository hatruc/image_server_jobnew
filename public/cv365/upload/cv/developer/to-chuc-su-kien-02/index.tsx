				...
				<div id="form-cv">
						...
						<div className="all" style={{ paddingTop: 0 }}>
							...
							<div id="cv-content" style={{}}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block">
									<div id="block01" className="cvo-block ui-sortable-handle" style={{ marginTop: '8.6px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											<div id="exp1" className="ctbx experience" style={{ marginTop: '4.3px' }}>
												{' '}
									...
									<div id="block02" className="cvo-block ui-sortable-handle" style={{ marginTop: '8.6px' }}>
										<div className="blockControls">
											<div title="Di chuyển khối" className="show-layout-editor">
												<i className="fa fa-bars" />
											</div>
										...
										<div id="experience-table">
											...
											<div id="exp2" className="ctbx experience" style={{ marginTop: '4.3px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
											...
											<div id="exp3" className="ctbx experience" style={{ marginTop: '4.3px' }}>
												{' '}
												<div className="fieldgroup_controls">
													<div className="clone">
														<i className="fa fa-plus" /> Thêm
					...
					<div className="cv_page page_more height_page" data-page={3}>
						<div className="all" style={{ paddingTop: 0 }}>
							...
							<div id="cv-content" style={{ paddingBottom: '913.4px' }}>
								<div className="ir connectedSortable sort_block ui-sortable" id="sort_block" />
							</div>
							<div className="clr" />
						</div>
