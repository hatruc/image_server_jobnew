									...
									<div id="box03" className="block cvo-block box-skills ui-sortable-handle">
										...
										<div className="exp content-edit skill">
											...
											<div className="ctbx">
												...
												<p className="skill-name" cv-form-field="true" contentEditable="true">
													Xử lý các sự cố về máy tính và mạng cũng như các phần mềm hỗ trợ công việc kỹ thuật, internet, văn phòng. Có kinh nghiệm sử
													dụng và triển khai phần mềm bán hàng, kế toán, chấm công.
												</p>
												<div className="bar-exp">
													<div style={{ width: '80%' }} />
												</div>
								...
								<div id="experience-table">
									<div id="exp1" className="ctbx experience">
										...
										<div
											...
											cvo-placeholder="Mô tả chi tiết công việc, những gì đạt được trong quá trình làm việc."
										>
											Kết quả: Thu hút được rất nhiều khách hàng đăng ký tham gia trải nghiệm các dịch vụ kết nối mạng của công ty, vượt kế hoạch 20%.{' '}
										</div>
									</div>{' '}
								</div>
							</div>
