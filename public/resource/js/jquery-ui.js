			...
			_on: function (i, s, n) {
				...
				'boolean' != typeof i && ((n = s), (s = i), (i = !1)),
					...
					e.each(n, function (n, r) {
						function h() {
							return i || (o.options.disabled !== !0 && !e(this).hasClass('ui-state-disabled'))
		...
		e.each({ show: 'fadeIn', hide: 'fadeOut' }, function (t, i) {
			e.Widget.prototype['_' + t] = function (s, n, a) {
				...
				;(n = n || {}),
					...
					o && e.effects && (e.effects.effect[r] || (e.uiBackCompat !== !1 && e.effects[r]))
						? s[t](n)
						: r !== t && s[r]
...
;(function (e, t) {
	...
	;(e.position = {
		...
		(e.fn.position = function (t) {
			...
			return (
				9 === _.nodeType
					? ((c = v.width()), (f = v.height()), (m = { top: 0, left: 0 }))
					: e.isWindow(_)
					? ((c = v.width()), (f = v.height()), (m = { top: v.scrollTop(), left: v.scrollLeft() }))
					: _.preventDefault
					? ((t.at = 'left top'), (c = f = 0), (m = { top: _.pageY, left: _.pageX }))
					: ((c = v.outerWidth()), (f = v.outerHeight()), (m = v.offset())),
				(g = e.extend({}, m)),
				...
				this.each(function () {
					var l,
						...
						_ = s(this, 'marginLeft'),
						k = s(this, 'marginTop'),
						D = d + _ + s(this, 'marginRight') + b.width,
					...
					'right' === t.my[0] ? (S.left -= d) : 'center' === t.my[0] && (S.left -= d / 2),
						...
						(S.left += M[0]),
						(S.top += M[1]),
						e.support.offsetFractions || ((S.left = r(S.left)), (S.top = r(S.top))),
						(l = { marginLeft: _, marginTop: k }),
			...
			fit: {
				left: function (e, t) {
					var i,
						...
						l = n - r,
						h = r + t.collisionWidth - o - n
					t.collisionWidth > o
						? l > 0 && 0 >= h
							? ((i = e.left + l + t.collisionWidth - o - n), (e.left += l - i))
							: (e.left = h > 0 && 0 >= l ? n : l > h ? n + o - t.collisionWidth : n)
						: l > 0
						? (e.left += l)
						: h > 0
						? (e.left -= h)
				...
				top: function (e, t) {
					var i,
						...
						l = n - r,
						h = r + t.collisionHeight - o - n
					t.collisionHeight > o
						? l > 0 && 0 >= h
							? ((i = e.top + l + t.collisionHeight - o - n), (e.top += l - i))
							: (e.top = h > 0 && 0 >= l ? n : l > h ? n + o - t.collisionHeight : n)
						: l > 0
						? (e.top += l)
						: h > 0
						? (e.top -= h)
			...
			flip: {
				left: function (e, t) {
					...
					0 > u
						...
						: d > 0 &&
						  ((s = e.left - t.collisionPosition.marginLeft + c + p + f - l),
				...
				top: function (e, t) {
					...
					0 > u
						...
						: d > 0 &&
						  ((i = e.top - t.collisionPosition.marginTop + p + f + m - l),
					...
					return (
						...
						1 === a.length &&
							(/left|center|right/.test(a[0])
								? (a[1] = 'center')
								: ((a[1] = a[0]), (a[0] = 'center'))),
						i.call(this, e.extend(s, { at: a[0] + n[0] + ' ' + a[1] + n[1], offset: t }))
					)
				}
			})(jQuery)
})(jQuery)
;(function (e) {
	e.widget('ui.draggable', e.ui.mouse, {
		...
		_mouseCapture: function (t) {
			var i = this.options
			return this.helper || i.disabled || e(t.target).is('.ui-resizable-handle')
				? !1
		...
		_generatePosition: function (t) {
			...
			if (this.originalPosition) {
				...
				if (i.grid) {
					var h = i.grid[1]
						? this.originalPageY + Math.round((o - this.originalPageY) / i.grid[1]) * i.grid[1]
						: this.originalPageY
					o = r
						? h - this.offset.click.top < r[1] || h - this.offset.click.top > r[3]
						...
						: h
					var u = i.grid[0]
						? this.originalPageX + Math.round((a - this.originalPageX) / i.grid[0]) * i.grid[0]
						: this.originalPageX
					a = r
						? u - this.offset.click.left < r[0] || u - this.offset.click.left > r[2]
			...
			return {
				top:
					...
					('fixed' == this.cssPosition ? -this.scrollParent.scrollTop() : n ? 0 : s.scrollTop()),
				left:
					a -
					this.offset.click.left -
					this.offset.relative.left -
					this.offset.parent.left +
					('fixed' == this.cssPosition ? -this.scrollParent.scrollLeft() : n ? 0 : s.scrollLeft()),
			}
		},
		_clear: function () {
						...
						this.instance._intersectsWith(this.instance.containerCache) &&
							...
							e.each(s.sortables, function () {
								return (
									...
									this != o &&
										this.instance._intersectsWith(this.instance.containerCache) &&
										e.ui.contains(o.instance.element[0], this.instance.element[0]) &&
										(a = !1),
									a
								)
							})),
				...
				for (
					...
					if (
						...
						if ('inner' != n.snapMode) {
							...
							m &&
								(i.position.top =
									s._convertPositionTo('relative', { top: p - s.helperProportions.height, left: 0 })
										.top - s.margins.top),
								g &&
									(i.position.top =
										s._convertPositionTo('relative', { top: f, left: 0 }).top - s.margins.top),
								v &&
									(i.position.left =
								...
								y &&
									(i.position.left =
										s._convertPositionTo('relative', { top: 0, left: c }).left - s.margins.left)
						}
						var b = m || g || v || y
						if ('outer' != n.snapMode) {
							...
							m &&
								(i.position.top =
									s._convertPositionTo('relative', { top: p, left: 0 }).top - s.margins.top),
								g &&
									(i.position.top =
										s._convertPositionTo('relative', {
								...
								v &&
									(i.position.left =
										s._convertPositionTo('relative', { top: 0, left: d }).left - s.margins.left),
								y &&
									(i.position.left =
										s._convertPositionTo('relative', {
											top: 0,
						...
						!s.snapElements[u].snapping &&
							...
							s.options.snap.snap.call(
								s.element,
								t,
								e.extend(s._uiHash(), { snapItem: s.snapElements[u].item })
							),
			...
			switch (s) {
				...
				case 'intersect':
					return (
						...
						h > a - t.helperProportions.width / 2 &&
						o + t.helperProportions.height / 2 > u &&
						d > r - t.helperProportions.height / 2
					)
				case 'pointer':
					var c =
							(t.positionAbs || t.position.absolute).left + (t.clickOffset || t.offset.click).left,
						p = (t.positionAbs || t.position.absolute).top + (t.clickOffset || t.offset.click).top,
						f = e.ui.isOver(p, c, u, l, i.proportions.height, i.proportions.width)
					return f
				case 'touch':
					return (
						((o >= u && d >= o) || (r >= u && d >= r) || (u > o && r > d)) &&
				...
				e: for (var o = 0; s.length > o; o++)
					if (
						!(
							...
							(t && !s[o].accept.call(s[o].element[0], t.currentItem || t.element))
						)
					) {
						...
						if (!this.options.disabled && !this.greedyChild && this.visible) {
							...
							if (n) {
								...
								if (this.options.greedy) {
									...
									r.length &&
										((a = e.data(r[0], 'droppable')), (a.greedyChild = 'isover' == n ? 1 : 0))
								}
...
;(function (e) {
	e.widget('ui.resizable', e.ui.mouse, {
		...
		_destroy: function () {
			...
			return (
				this.originalElement.css('resize', this.originalResizeStyle), t(this.originalElement), this
			)
		},
		_mouseCapture: function (t) {
			var i = !1
		...
		_mouseStart: function (i) {
			...
			s.containment &&
				((o += e(s.containment).scrollLeft() || 0), (r += e(s.containment).scrollTop() || 0)),
			...
			return (
				e('body').css('cursor', 'auto' == h ? this.axis + '-resize' : h),
		...
		_mouseStop: function (t) {
			...
			if (this._helper) {
				var n = this._proportionallyResizeElements,
					...
					h = { width: s.helper.width() - r, height: s.helper.height() - o },
					l =
						parseInt(s.element.css('left'), 10) + (s.position.left - s.originalPosition.left) ||
						null,
		...
		e.ui.plugin.add('resizable', 'containment', {
			start: function () {
				...
				if (o)
					if (((i.containerElement = e(o)), /document/.test(a) || a == document))
						...
						e(['Top', 'Right', 'Left', 'Bottom']).each(function (e, i) {
							...
							(i.containerSize = { height: r.innerHeight() - h[3], width: r.innerWidth() - h[1] })
			...
			resize: function (t) {
				...
				h[0] != document && /static/.test(h.css('position')) && (r = n),
					a.left < (i._helper ? n.left : 0) &&
						((i.size.width =
							i.size.width + (i._helper ? i.position.left - n.left : i.position.left - r.left)),
				...
				var l = Math.abs(
						(i._helper ? i.offset.left - r.left : i.offset.left - r.left) + i.sizeDiff.width
					),
					u = Math.abs(
						(i._helper ? i.offset.top - r.top : i.offset.top - n.top) + i.sizeDiff.height
					),
		...
		e.ui.plugin.add('resizable', 'grid', {
			resize: function (t) {
				...
				;/^(se|s|e)$/.test(r)
					? ((i.size.width = a.width + h), (i.size.height = a.height + l))
					: /^(ne)$/.test(r)
				...
				return (
					...
					this.selectees.each(function () {
						...
						if (h && h.element != i.element[0]) {
							var l = !1
							'touch' == s.tolerance
								? (l = !(h.left > o || n > h.right || h.top > r || a > h.bottom))
								: 'fit' == s.tolerance &&
								  (l = h.left > n && o > h.right && h.top > a && r > h.bottom),
								l
									? (h.selected && (h.$element.removeClass('ui-selected'), (h.selected = !1)),
									  h.unselecting &&
											(h.$element.removeClass('ui-unselecting'), (h.unselecting = !1)),
									  h.selecting ||
											(h.$element.addClass('ui-selecting'),
											(h.selecting = !0),
											i._trigger('selecting', t, { selecting: h.element })))
									: (h.selecting &&
											((t.metaKey || t.ctrlKey) && h.startselected
												...
												: (h.$element.removeClass('ui-selecting'),
												  (h.selecting = !1),
												  h.startselected &&
														(h.$element.addClass('ui-unselecting'), (h.unselecting = !0)),
												  i._trigger('unselecting', t, { unselecting: h.element }))),
									  h.selected &&
											(t.metaKey ||
												t.ctrlKey ||
												h.startselected ||
		...
		_mouseDrag: function (t) {
			...
			for (var n = this.items.length - 1; n >= 0; n--) {
				...
				if (
					...
					('semi-dynamic' == this.options.type ? !e.contains(this.element[0], o) : !0)
				) {
					if (
				...
				for (var a = n.length - 1; a >= 0; a--)
					for (var o = e(n[a]), r = o.length - 1; r >= 0; r--) {
						...
						h &&
							...
							!h.options.disabled &&
							s.push([
								e.isFunction(h.options.items)
									? h.options.items.call(h.element)
									: e(h.options.items, h.element)
				...
				for (var a = n.length - 1; a >= 0; a--)
					for (var o = e(n[a]), r = o.length - 1; r >= 0; r--) {
						...
						h &&
							...
							(s.push([
								e.isFunction(h.options.items)
									? h.options.items.call(h.element[0], t, { item: this.currentItem })
									: e(h.options.items, h.element),
								h,
							]),
			...
			for (var a = s.length - 1; a >= 0; a--)
				for (var l = s[a][1], u = s[a][0], r = 0, d = u.length; d > r; r++) {
					...
					c.data(this.widgetName + '-item', l),
						i.push({ item: c, instance: l, width: 0, height: 0, left: 0, top: 0 })
				}
		},
				...
				if (1 === this.containers.length)
					...
					for (
						var a = 1e4,
							...
							h = this.containers[s].floating ? 'width' : 'height',
							l = this.positionAbs[r] + this.offset.click[r],
							u = this.items.length - 1;
						u >= 0;
						u--
					)
						if (
							e.contains(this.containers[s].element[0], this.items[u].item[0]) &&
							this.items[u].item[0] != this.currentItem[0]
						) {
							var d = this.items[u].item.offset()[r],
								c = !1
							Math.abs(d - l) > Math.abs(d + this.items[u][h] - l) &&
								((c = !0), (d += this.items[u][h])),
								a > Math.abs(d - l) &&
									((a = Math.abs(d - l)), (o = this.items[u]), (this.direction = c ? 'up' : 'down'))
						}
			...
			if (
				...
				a = this.containment
					? h - this.offset.click.left < this.containment[0] ||
					  h - this.offset.click.left > this.containment[2]
						? h - this.offset.click.left < this.containment[0]
							? h + i.grid[0]
							: h - i.grid[0]
						: h
	...
	;(i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth = 'hide'),
		...
		e.widget('ui.accordion', {
			...
			refresh: function () {
				...
				'fill' === s
					? (e.support.minHeight || ((i = n.css('overflow')), n.css('overflow', 'hidden')),
					  (t = n.height()),
										...
										;(i.now = Math.round(e)),
											'height' !== i.prop
												...
												: 'content' !== h.options.heightStyle &&
												  ((i.now = Math.round(a - t.outerHeight() - l)), (l = 0))
									},
							  }),
							  undefined)
							: t.animate(i, r, o, p)
						...
						a &&
							s.add(n).each(function (i) {
								return e.contains(this, a)
									? ((t.options.active = Math.floor(i / 2)), !1)
									: undefined
							})
					}
					i.call(this)
			...
			(function (e, t) {
				...
				t._findActive = function (e) {
					return (
						...
						e &&
							'number' != typeof e &&
							((e = this.headers.index(this.headers.filter(e))), -1 === e && (e = !1)),
						i.call(this, e)
					)
				}
			})(jQuery, jQuery.ui.accordion.prototype),
					...
					null === e.animate &&
						(e.animate = e.animated
							? 'slide' === e.animated
								...
								? { duration: 200, down: { easing: 'easeOutBounce', duration: 1e3 } }
								: e.animated
							: !1),
						i.call(this)
				}
	...
	$.extend(Datepicker.prototype, {
		...
		_attachments: function (e, t) {
			...
			t.append && t.append.remove(),
				i &&
					((t.append = $('<span class="' + this._appendClass + '">' + i + '</span>')),
			...
			if (
				...
				;(t.trigger = $(
					this._get(t, 'buttonImageOnly')
						? $('<img/>').addClass(this._triggerClass).attr({ src: r, alt: a, title: a })
						: $('<button type="button"></button>')
								.addClass(this._triggerClass)
								.html('' == r ? a : $('<img/>').attr({ src: r, alt: a, title: a }))
				)),
			...
			if (this._get(e, 'autoSize') && !e.inline) {
				...
				if (i.match(/[DM]/)) {
					...
					t.setMonth(s(this._get(e, i.match(/MM/) ? 'monthNames' : 'monthNamesShort'))),
						t.setDate(
							s(this._get(e, i.match(/DD/) ? 'dayNames' : 'dayNamesShort')) + 20 - t.getDay()
						)
				}
			...
			if (t.hasClass(this.markerClassName)) {
				...
				$.removeData(e, PROP_NAME),
					'input' == s
						...
						: ('div' == s || 'span' == s) && t.removeClass(this.markerClassName).empty()
			}
		},
				...
				if (s !== !1) {
					...
					if (
						...
						t.dpDiv.zIndex($(e).zIndex() + 1),
							...
							$.effects && ($.effects.effect[r] || $.effects[r])
								? t.dpDiv.show(r, $.datepicker._get(t, 'showOptions'), o, h)
								: t.dpDiv[r || 'show'](r ? o : null, h),
							(r && o) || h(),
		...
		_hideDatepicker: function (e) {
			...
			if (t && (!e || t == $.data(e, PROP_NAME)) && this._datepickerShowing) {
				...
				$.effects && ($.effects.effect[i] || $.effects[i])
					...
					: t.dpDiv['slideDown' == i ? 'slideUp' : 'fadeIn' == i ? 'fadeOut' : 'hide'](
							i ? s : null,
							n
					  ),
					i || n(),
		...
		_adjustDate: function (e, t, i) {
			...
			this._isDisabledDatepicker(s[0]) ||
				(this._adjustInstDate(n, t + ('M' == i ? this._get(n, 'showCurrentAtPos') : 0), i),
		...
		_selectMonthYear: function (e, t, i) {
			var s = $(e),
				n = this._getInst(s[0])
			;(n['selected' + ('M' == i ? 'Month' : 'Year')] = n['draw' + ('M' == i ? 'Month' : 'Year')] =
		...
		parseDate: function (e, t, i) {
				...
				var n = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort,
					...
					m = function (e, i, s) {
						...
						if (
							($.each(n, function (e, i) {
								var s = i[1]
								return t.substr(v, s.length).toLowerCase() == s.toLowerCase()
									? ((a = i[0]), (v += s.length), !1)
									: undefined
							}),
							-1 != a)
			...
			if (
				(-1 == h
					...
					: 100 > h &&
					  (h +=
							new Date().getFullYear() - (new Date().getFullYear() % 100) + (s >= h ? 0 : -100)),
				d > -1)
			)
				for (l = 1, u = d; ; ) {
		...
		_determineDate: function (e, t, i) {
			var s = function (e) {
				...
				n = function (t) {
					...
					for (
						var s = (t.toLowerCase().match(/^c/) ? $.datepicker._getDate(e) : null) || new Date(),
							n = s.getFullYear(),
							a = s.getMonth(),
							r = s.getDate(),
		...
		_generateHTML: function (e) {
			...
			if ((0 > p && ((p += 12), f--), c)) {
				var m = this._daylightSavingAdjust(
					new Date(c.getFullYear(), c.getMonth() - r[0] * r[1] + 1, c.getDate())
				)
			...
			for (var H = this._getDefaultDate(e), F = '', z = 0; r[0] > z; z++) {
				...
				for (var O = 0; r[1] > O; O++) {
					var j = this._daylightSavingAdjust(new Date(f, p, e.selectedDay)),
						...
						L = ''
					if (l) {
						if (((L += '<div class="ui-datepicker-group'), r[1] > 1))
							switch (O) {
								case 0:
					...
					L +=
						...
						this._generateMonthYearHeader(e, p, f, d, c, z > 0 || O > 0, N, C) +
					...
					for (
						...
						R +=
							'<th' +
							((Y + D + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : '') +
							'>' +
							'<span title="' +
							S[J] +
							'">' +
					...
					for (var q = this._daylightSavingAdjust(new Date(f, p, 1 - K)), G = 0; V > G; G++) {
						...
						for (
							...
							var X = A ? A.apply(e.input ? e.input[0] : null, [q]) : [!0, ''],
								Z = q.getMonth() != p,
								et = (Z && !I) || !X[0] || (d && d > q) || (c && q > c)
							;(Q +=
								'<td class="' +
								((Y + D + 6) % 7 >= 5 ? ' ui-datepicker-week-end' : '') +
								(Z ? ' ui-datepicker-other-month' : '') +
								((q.getTime() == j.getTime() && p == e.selectedMonth && e._keyEvent) ||
								(H.getTime() == q.getTime() && H.getTime() == j.getTime())
									? ' ' + this._dayOverClass
									: '') +
								(et ? ' ' + this._unselectableClass + ' ui-state-disabled' : '') +
								(Z && !P
									? ''
									: ' ' +
									  X[1] +
									  (q.getTime() == u.getTime() ? ' ' + this._currentClass : '') +
									  (q.getTime() == t.getTime() ? ' ui-datepicker-today' : '')) +
								'"' +
								((Z && !P) || !X[2] ? '' : ' title="' + X[2] + '"') +
								(et
									? ''
								...
								(Z && !P
									...
									: '<a class="ui-state-default' +
									  (q.getTime() == t.getTime() ? ' ui-state-highlight' : '') +
					...
					p++,
						...
						(L +=
							...
							(l
								? '</div>' +
								  (r[0] > 0 && O == r[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : '')
								: '')),
						(E += L)
				}
				F += E
		...
		_generateMonthYearHeader: function (e, t, i, s, n, a, r, o) {
			...
			if ((u || (d += c + (!a && h && l ? '' : '&#xa0;')), !e.yearshtml))
				if (((e.yearshtml = ''), a || !l)) d += '<span class="ui-datepicker-year">' + i + '</span>'
				else {
		...
		_create: function () {
			...
			;(s = (this.uiDialog = e('<div>'))
				...
				(this.uiDialogTitlebarCloseText = e('<span>'))
					...
					.text(l.closeText)
					.appendTo(a),
				(r = e('<span>').uniqueId().addClass('ui-dialog-title').html(u).prependTo(n)),
				(o = (this.uiDialogButtonPane = e('<div>')).addClass(
					'ui-dialog-buttonpane ui-widget-content ui-helper-clearfix'
				)),
				(this.uiButtonSet = e('<div>')).addClass('ui-dialog-buttonset').appendTo(o),
				s.attr({ role: 'dialog', 'aria-labelledby': r.attr('id') }),
					...
					keydown: function (i) {
						if (l.modal && i.keyCode === e.ui.keyCode.TAB) {
							var n = e(':tabbable', s),
								a = n.filter(':first'),
								r = n.filter(':last')
							return i.target !== r[0] || i.shiftKey
				...
				return (
					...
					this.options.modal &&
						...
						e('.ui-dialog').each(function () {
							this !== n.uiDialog[0] &&
								((s = e(this).css('z-index')), isNaN(s) || (i = Math.max(i, s)))
						}),
						(e.ui.dialog.maxZ = i)),
					this
				)
		...
		moveToTop: function (t, i) {
			...
			return (n.modal && !t) || (!n.stack && !n.modal)
				...
				: (n.zIndex > e.ui.dialog.maxZ && (e.ui.dialog.maxZ = n.zIndex),
				  ...
				  (s = { scrollTop: this.element.scrollTop(), scrollLeft: this.element.scrollLeft() }),
				  (e.ui.dialog.maxZ += 1),
		...
		_position: function (t) {
			...
			t
				? (('string' == typeof t || ('object' == typeof t && '0' in t)) &&
						...
						(t = {
							my:
								s[0] + (0 > n[0] ? n[0] : '+' + n[0]) + ' ' + s[1] + (0 > n[1] ? n[1] : '+' + n[1]),
							at: s.join(' '),
						})),
		...
		_setOption: function (t, s) {
			...
			switch (t) {
				...
				case 'disabled':
					...
					break
				case 'draggable':
					;(n = r.is(':data(draggable)')),
						n && !s && r.draggable('destroy'),
						...
						(this.range = e('<div></div>')
							...
							.addClass(
								'ui-slider-range ui-widget-header' +
									('min' === n.range || 'max' === n.range ? ' ui-slider-range-' + n.range : '')
							))),
		...
		_mouseCapture: function (t) {
			...
			return d.disabled
				...
				: ((this.elementSize = {
				  ...
				  d.range === !0 && this.values(1) === d.min && ((o += 1), (a = e(this.handles[o]))),
				  (r = this._start(t, o)),
				  r === !1
						? !1
...
;(function (e, t) {
	...
	function s(e) {
		return (
			e.hash.length > 1 &&
			e.href.replace(a, '') === location.href.replace(a, '').replace(/\s/g, '%20')
		)
	}
	var n = 0,
		a = /#.*$/
	e.widget('ui.tabs', {
		...
		_create: function () {
			...
			;(this.running = !1),
				...
				n !== !1 &&
					((n = this.tabs.index(this.tabs.eq(n))), -1 === n && (n = s.collapsible ? !1 : 0)),
				(s.active = n),
				!s.collapsible && s.active === !1 && this.anchors.length && (s.active = 0),
				e.isArray(s.disabled) &&
					(s.disabled = e
						.unique(
							s.disabled.concat(
				...
				this.anchors.each(function (i, n) {
					...
					s(n)
						...
						: ((r = t._tabId(l)),
						  (a = '#' + r),
						  (o = t.element.find(a)),
						  o.length || ((o = t._createPanel(r)), o.insertAfter(t.panels[i - 1] || t.tablist)),
		...
		_setupHeightStyle: function (t) {
			var i,
				...
				n = this.element.parent()
			'fill' === t
				? (e.support.minHeight || ((s = n.css('overflow')), n.css('overflow', 'hidden')),
				  (i = n.height()),
				  this.element.siblings(':visible').each(function () {
						var t = e(this),
							s = t.css('position')
		...
		e.uiBackCompat !== !1 &&
				...
				_create: function () {
					...
					this._on({
						tabsbeforeload: function (s, n) {
							return e.data(n.tab[0], 'cache.tabs')
								? (s.preventDefault(), t)
			...
			e.widget('ui.tabs', e.ui.tabs, {
				...
				enable: function (t) {
					var i,
						s = this.options
					;((t && s.disabled === !0) ||
						(e.isArray(s.disabled) && -1 !== e.inArray(t, s.disabled))) &&
						(i = !0),
						this._superApply(arguments),
			...
			e.widget('ui.tabs', e.ui.tabs, {
				...
				add: function (i, s, n) {
					...
					return (
						h.addClass('ui-state-default ui-corner-top').data('ui-tabs-destroy', !0),
						h.attr('aria-controls', l),
						(a = n >= this.tabs.length),
						(o = this.element.find('#' + l)),
						o.length ||
							((o = this._createPanel(l)),
							a
								? n > 0
				...
				remove: function (t) {
					...
					return (
						s.hasClass('ui-tabs-active') &&
							...
							this._activate(t + (this.anchors.length > t + 1 ? 1 : -1)),
						(i.disabled = e.map(
			...
			e.widget('ui.tabs', e.ui.tabs, {
				...
				_tabId: function (t) {
					...
					return (
						(s = s[0]),
						e(s).closest('li').attr('aria-controls') ||
							(s.title && s.title.replace(/\s/g, '_').replace(/[^\w\u00c0-\uFFFF\-]/g, '')) ||
			...
			(function () {
				...
				e.widget('ui.tabs', e.ui.tabs, {
					...
					_create: function () {
						...
						null == t.active &&
							t.cookie &&
							((e = parseInt(this._cookie(), 10)), -1 === e && (e = !1), (t.active = e)),
							this._super()
					},
					_cookie: function (i) {
						var s = [this.cookie || (this.cookie = this.options.cookie.name || 'ui-tabs-' + ++t)]
						return (
							arguments.length && (s.push(i === !1 ? -1 : i), s.push(this.options.cookie)),
			...
			e.widget('ui.tabs', e.ui.tabs, {
				_trigger: function (t, i, s) {
					var n = e.extend({}, s)
					return (
						'load' === t && ((n.panel = n.panel[0]), (n.tab = n.tab.find('.ui-tabs-anchor')[0])),
						this._super(t, i, n)
					)
				},
			}),
			e.widget('ui.tabs', e.ui.tabs, {
				...
				_getFx: function () {
					var t,
						...
						s = this.options.fx
					return (
						s && (e.isArray(s) ? ((t = s[0]), (i = s[1])) : (t = i = s)),
						s ? { show: i, hide: t } : null
					)
				},
				_toggle: function (e, i) {
					...
					function n() {
						i.newTab.closest('li').addClass('ui-tabs-active ui-state-active'),
							o.length && h.show
								? o.animate(h.show, h.show.duration, function () {
										s()
								  })
								: (o.show(), s())
					}
					...
					return h
						? ((a.running = !0),
						  r.length && h.hide
								? r.animate(h.hide, h.hide.duration, function () {
										i.oldTab.closest('li').removeClass('ui-tabs-active ui-state-active'), n()
								  })
...
;(function (e) {
	...
	e.widget('ui.tooltip', {
			...
			if (n) {
				...
				s.is('[title]') &&
					...
					this.options.track && i && /^mouse/.test(i.type)
						...
						: o.position(e.extend({ of: s }, this.options.position)),
					o.hide(),
		...
		_tooltip: function (t) {
			...
			return (
				e('<div>').addClass('ui-tooltip-content').appendTo(n),
					...
					return (
						...
						m(l, function (t, a) {
							var o,
								...
								l = a.space || 'rgba'
							return h
								? ((o = s[l](h)), (s[d[l].cache] = o[d[l].cache]), (n = s._rgba = o._rgba), !1)
								: i
						}),
				...
				;(f.style.cssText = 'background-color:rgba(1,1,1,.5)'),
											...
											: m(d, function (t, i) {
													...
													m(i.props, function (e, t) {
														...
														c[n] &&
															...
															((c[n][3] = 1), i.from && (c._rgba = i.from(c[n])))
											  }),
									  this)
									: i
							)
					...
					(d.hsla.from = function (e) {
						...
						var t = e[0] / 360,
							...
							r = 2 * s - o
						return [
							Math.round(255 * a(r, o, t + 1 / 3)),
							Math.round(255 * a(r, o, t)),
							Math.round(255 * a(r, o, t - 1 / 3)),
							n,
						]
					}),
			...
			(function () {
				function i() {
					...
					if (s && s.length && s[0] && s[s[0]])
						for (i = s.length; i--; )
							(t = s[i]), 'string' == typeof s[t] && (n[e.camelCase(t)] = s[t])
				...
				e.extend(e.effects, {
					...
					restore: function (e, i) {
						...
						for (a = 0; i.length > a; a++)
							null !== i[a] && ((n = e.data(s + i[a])), n === t && (n = ''), e.css(i[a], n))
					},
...
;(function (e) {
	...
	e.effects.effect.blind = function (s, n) {
		...
		l.parent().is('.ui-effects-wrapper') ? e.effects.save(l.parent(), h) : e.effects.save(l, h),
			l.show(),
			(a = e.effects.createWrapper(l).css({ overflow: 'hidden' })),
			(o = a[p]()),
	...
	e.effects.effect.bounce = function (t, i) {
		...
		for (
			...
			(n = {}),
				...
				(c = h ? 2 * c : c / 2)
		h && ((n = { opacity: 0 }), (n[v] = (y ? '-=' : '+=') + c), o.animate(n, m, g)),
			o.queue(function () {
...
;(function (e) {
	e.effects.effect.explode = function (t, i) {
		...
		var a,
			...
			b = []
		for (a = 0; d > a; a++)
			for (l = g.top + a * y, u = a - (d - 1) / 2, o = 0; c > o; o++)
				(r = g.left + o * v),
					(h = o - (c - 1) / 2),
					p
						.clone()
						...
						.animate(
							{ left: r + (m ? 0 : h * v), top: l + (m ? 0 : u * y), opacity: m ? 1 : 0 },
							t.duration || 500,
							t.easing,
							s
						)
